...
?>
    《<a href="show_reserve.php?classroom=<?echo $classroom;?>"><font color="#000080">本週</font></a>》
<?}
  else{
?>
    《<a href="show_reserve.php?classroom=<?echo $classroom;?>&nextfirst=<?echo date("Y-m-d",mktime(0,0,0,$tok[1],$tok[2]+7,$tok[0]))?>"><font color="#000080">下一週</font></a>》
<?}
?>
