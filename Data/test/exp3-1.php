...
<body>
<div align="center"><span style="text-align: center"></span><img src="教材/CH1.PNG"  alt="" width="662" height="337" usemap="#Map" align="middle"/>
  <map name="Map">
   <area shape="rect" coords="305,47,367,90" href="#" onClick="MM_openBrWindow('../test2.php?com=com4','SW1','scrollbars=yes,width=600,height=600')"/>
